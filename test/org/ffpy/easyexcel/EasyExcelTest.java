...
public class EasyExcelTest {
    ...
    public void example2() throws IOException {
        CellStyleBuilder shortDateFormatStyle = CellStyleBuilder.of()
                .dateFormat("yyyy-MM-dd");

        CellStyleBuilder longDateFormatStyle = CellStyleBuilder.of()
        ...
        Excels.createWorkbook().createSheet()
                ...
                .nextCell().value("bb")
                .nextCell().value("cc")
                .nextRow().style(shortDateFormatStyle).value(new Date())
                .nextCell().style(longDateFormatStyle).value(Calendar.getInstance())
                .autoColumnSize()
                .end()
